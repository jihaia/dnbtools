require 'fileutils'
require 'dnb_tools/util/data/seed_proxy'

module DnbTools::Util::Data::Seeder
  ...
  def self.run!(options={})
    ...
    seeds = files.map do |file|
      ...
      DnbTools::Util::Data::SeedProxy.new(name, version, file)
    end
...
end # module DnbTools::Util::Data::Seeder
